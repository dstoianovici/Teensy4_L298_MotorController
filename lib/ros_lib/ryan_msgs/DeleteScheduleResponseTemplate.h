#ifndef _ROS_ryan_msgs_DeleteScheduleResponseTemplate_h
#define _ROS_ryan_msgs_DeleteScheduleResponseTemplate_h
...
namespace ryan_msgs
{
  ...
  class DeleteScheduleResponseTemplate : public ros::Msg
  {
    public:
    ...
    DeleteScheduleResponseTemplate():
      response_result(0),
      success_result(""),
      errors("")
    {
    ...
    const char * getType(){ return "ryan_msgs/DeleteScheduleResponseTemplate"; };
