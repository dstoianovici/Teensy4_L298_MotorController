#ifndef _ROS_ryan_msgs_InterruptResult_h
#define _ROS_ryan_msgs_InterruptResult_h
...
namespace ryan_msgs
{
  ...
  class InterruptResult : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ryan_msgs/InterruptResult"; };
