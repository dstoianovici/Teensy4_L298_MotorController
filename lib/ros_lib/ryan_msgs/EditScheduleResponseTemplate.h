#ifndef _ROS_ryan_msgs_EditScheduleResponseTemplate_h
#define _ROS_ryan_msgs_EditScheduleResponseTemplate_h
...
namespace ryan_msgs
{
  ...
  class EditScheduleResponseTemplate : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ryan_msgs/EditScheduleResponseTemplate"; };
