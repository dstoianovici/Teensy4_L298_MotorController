#ifndef _ROS_ryan_msgs_SetSchedulerResponseTemplate_h
#define _ROS_ryan_msgs_SetSchedulerResponseTemplate_h
...
namespace ryan_msgs
{
  ...
  class SetSchedulerResponseTemplate : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ryan_msgs/SetSchedulerResponseTemplate"; };
