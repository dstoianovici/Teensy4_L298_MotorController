#ifndef _ROS_ryan_msgs_IntrRequest_h
#define _ROS_ryan_msgs_IntrRequest_h
...
namespace ryan_msgs
{
  ...
  class IntrRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ryan_msgs/IntrRequest"; };
    const char * getMD5(){ return "50800c862160ad01a2a34426ca606e04"; };
